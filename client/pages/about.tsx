  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center">
        <div className="w-full max-w-sm bg-white rounded-lg border border-red-600 shadow-md shadow-red-500 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100">
          <div className="flex flex-col items-center pb-10">
            ...
            <p className="m-4 font-light text-gray-700 dark:text-gray-400">
